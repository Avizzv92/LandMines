...
@implementation LMGameCenterManager
			...
			[achievement reportAchievementWithCompletionHandler: ^(NSError *error)
             {
                 if(!error)
                 {/*
                     UIAlertView *alert = [[UIAlertView alloc]initWithTitle:[NSString stringWithFormat:@"Objective Completed!"] message:@"Your achievement has been successfully submitted to Game Center." delegate:nil cancelButtonTitle:@"Close" otherButtonTitles:nil];
                     [alert show];
                     [alert release];*/
                 }
