...
- (void) applicationDidFinishLaunching:(UIApplication*)application
{
    ...
    if(![fm fileExistsAtPath:[FileHelper getSettingsPath]])
    {
        ...
        [settingsDictionary setValue:[NSNumber numberWithFloat:.5f] forKey:@"SFXVolume"];
        [settingsDictionary setValue:[NSNumber numberWithFloat:.5f] forKey:@"MusicVolume"];
        [settingsDictionary setValue:[NSNumber numberWithInt:0] forKey:@"CurrentObjective"];
        [settingsDictionary setValue:[NSNumber numberWithInt:1] forKey:@"isNew"];
    ...
    else
    {
        ...
        [[SimpleAudioEngine sharedEngine]setBackgroundMusicVolume:[[settingsDictionary objectForKey:@"MusicVolume"]floatValue]];
    }
...
- (void)applicationDidBecomeActive:(UIApplication *)application {
	if(![[GlobalManager sharedManager]isGamePaused])[[CCDirector sharedDirector] resume];
}
